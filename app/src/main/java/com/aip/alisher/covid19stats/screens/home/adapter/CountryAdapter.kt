package com.aip.alisher.covid19stats.screens.home.adapter
...
import com.aip.alisher.covid19stats.databinding.CountryRowBinding
import com.aip.alisher.covid19stats.screens.home.adapter.CountryAdapter.CountryHolder
import com.squareup.picasso.Picasso
import java.util.*

class CountryAdapter : RecyclerView.Adapter<CountryHolder>(), Filterable {
    private var onItemClickListener: OnItemClickListener? = null
    private var countriesList: List<CountryCovidInfo>? = null
    private var countriesListed: List<CountryCovidInfo>? = null
    private var context: Context? = null
    fun setCountryList(context: Context?, countriesList: List<CountryCovidInfo>) {
        ...
        return object : Filter() {
            override fun performFiltering(charSequence: CharSequence): FilterResults {
                ...
                countriesListed = if (charString.isEmpty()) {
                    ...
                    val filteredList: MutableList<CountryCovidInfo> = ArrayList()
            ...
            override fun publishResults(charSequence: CharSequence, filterResults: FilterResults) {
                countriesListed = filterResults.values as ArrayList<CountryCovidInfo>
    ...
    interface OnItemClickListener {
        fun onItemClick(item: CountryCovidInfo)
    }
}